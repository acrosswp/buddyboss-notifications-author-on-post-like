 ...
 * @since Notifications On Post Like For BuddyBoss 1.0.0
 */
...
class Notifications_On_Post_Like_For_BuddyBoss_Update {
	...
	public function get_db_version_raw() {
		return get_option( '_notifications_on_post_like_for_buddyboss_db_version', '0.0.1' );
	}
	...
	function version_bump() {
		update_option( '_notifications_on_post_like_for_buddyboss_db_version', NOTIFICATIONS_ON_POST_LIKE_FOR_BUDDYBOSS_VERSION );
	}
	...
	function version_updater() {
		...
		if ( version_compare( '1.0.0', $current_db ) ) {
			notifications_on_post_like_for_buddyboss_to_1_0_0();
		}
 ...
 */
function notifications_on_post_like_for_buddyboss_to_1_0_0() {
}